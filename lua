...
ScreenGui.Name = "Metodo MoreiraGUI"
...
StartButton.Text = "Start Metodo Moreira"
...
AntiCooldownLabel.Text = "Anti Cooldown (ON)"
...
local function StopScript()
    IsRunning = false
    IsLoading = false
    StartButton.Text = "stop Metodo Moreira"
    StartButton.BackgroundColor3 = Color3.fromRGB(50, 130, 255)
